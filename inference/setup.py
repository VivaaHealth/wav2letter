...
class CMakeBuild(build_ext):
    ...
    def build_extensions(self):
        ...
        use_cuda = "OFF" if check_env_flag("USE_CUDA") else "OFF"
        ...
        cmake_args = [
            ...
            "-DW2L_BUILD_FOR_PYTHON=OFF",
            "-DW2L_BUILD_INFERENCE=ON",
            "-DW2L_BUILD_TESTS=OFF",
            "-DW2L_INFERENCE_BUILD_TESTS=OFF",
            "-DW2L_INFERENCE_BUILD_EXAMPLES=OFF",
...
setup(
    ...
    long_description="",
    ext_modules=[CMakeExtension("wav2letter._inference")],
